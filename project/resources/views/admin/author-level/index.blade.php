...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3">{{ __('Level list') }}</h5>
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
		<li class="breadcrumb-item"><a href="javascript:;">{{ __('Author Level') }}</a></li>
		<li class="breadcrumb-item"><a href="{{ route('admin.blog.index') }}">{{ __('Level List') }}</a></li>
	</ol>
	</div>
</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               serverSide: true,
               searching: false,
               ajax: '{{ route('admin.level.datatables') }}',
               columns: [
