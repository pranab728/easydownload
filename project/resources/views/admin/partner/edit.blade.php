...
<div class="card">
  ...
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{route('admin.partner.edit',$data->id)}}">{{ __('Edit Partner') }}</a></li>
  </ol>
  </div>
</div>
    ...
    <div class="card-body">
      ...
      <form class="geniusform" action="{{route('admin.partner.update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="link"  placeholder="{{ __('Enter Link') }}" value="{{$data->link}}" required>
        </div>
          ...
          <div class="form-group">
              ...
              <div class="wrapper-image-preview">
                  <div class="box">
                      <div class="back-preview-image" style="background: url({{ $data->photo ? asset('assets/images/'.$data->photo):asset('assets/images/noimage.png') }});"></div>
