...
@section('content')
    ...
    <div class="card">
        ...
        <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Refund Orders') }}</h5>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
            <li class="breadcrumb-item"><a href="javascript:;">{{ __('All Orders') }}</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.order.index') }}">{{ __('Refund Orders') }}</a></li>
        </ol>
        </div>
    </div>
...
var table = $('#geniustable').DataTable({
               ...
               serverSide: true,
               searching: false,
               ajax: '{{ route('admin.refund.datatables') }}',
               columns: [
                        { data: 'order_number', name: 'order_number' },
                        { data: 'date', name: 'date' },
                        { data: 'total', name: 'total' },
                        { data: 'refund_seen', searchable: false, orderable: false },
