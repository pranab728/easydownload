...
<div class="card">
  ...
  <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Categories') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
  <ol class="breadcrumb">
            ...
            <div class="add-product-content1">
              <div class="row">
                <div class="col-md-6 offset-md-3">
                  ...
                  <form class="geniusform" action="{{route('admin.attr.update', $attr->id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
