...
//-----------------------------Clear cache end----------------
  ...
  Route::post('/profile/update', [DashboardController::class,'profileupdate'])->name('admin.profile.update');
    ...
    // UseStatementPass
    Route::get('/statements/datatables', [OrderController::class,'statedatatables'])->name('admin.statement.datatables');
    Route::get('/statements', [OrderController::class,'statement'])->name('admin.statement.index');
...
// Author Trending Route Start From Here
...
Route::post('the/genius/ocean/2441139', 'Frontend\FrontendController@subscription');
    ...
    Route::get('update-finalize', 'Frontend\FrontendController@updateFinalize');
...
Route::group(['middleware'=>'maintenance'],function(){
  ...
  Route::group(['middleware' => 'auth'], function() {
    ...
    Route::get('/all/author/', 'Frontend\FrontendController@allauthor')->name('front.authorr');
});
